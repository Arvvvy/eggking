...
async function loadModel() {
    if (!model) {
        try {
            model = await tf.loadGraphModel('https://cors-anywhere.herokuapp.com/https://raw.githubusercontent.com/Arvvvy/eggking/main/model/model.json'); // Sesuaikan path model
